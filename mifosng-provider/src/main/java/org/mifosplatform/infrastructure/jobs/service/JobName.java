...
public enum JobName {
	...
	APPLY_CHARGE_TO_OVERDUE_LOAN_INSTALLMENT("Apply penalty to overdue loans"), EXECUTE_STANDING_INSTRUCTIONS(
			...
			"Generate Mandatory Savings Schedule"), UPDATE_CLIENT_SUB_STATUS(
			"Update Client Sub-Status");
